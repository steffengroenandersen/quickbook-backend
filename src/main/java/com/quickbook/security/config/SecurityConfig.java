package com.quickbook.security.config;

import com.quickbook.security.error.CustomOAuth2AccessDeniedHandler;
import com.quickbook.security.error.CustomOAuth2AuthenticationEntryPoint;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/api/auth/login")).permitAll()
